...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        if (url.contains("/checkLogin.do")||url.contains("/userCheckLogin.do")||url.contains("/adminLogin.do")||url.contains("/SelectFlightinfoByOther.do")||url.contains("/addUser.do")||url.contains("/selectAllFlightinfoFU.do")) {
            return true;
        }
