...
<div class="jumbotron">
    <div style="height: 500px;" class="container">
        ...
        <div class="btn-group" role="group" aria-label="...">
            ...
            <a href="/selectAllUserinfo.do?user_acname=${user.accountname}"><button type="button" class="btn btn-default">查看我的乘车人</button></a>
        </div>
    </div>
</div>
<!-- Modal1 -->
