        ...
        <div class="col-lg-12">
            <div class="input-group">
                ...
                <div class="col-md-8 col-md-offset-8">
                        <a href="${pageContext.request.contextPath}/jumpAddFl.do">
                ...
                <ul class="pagination">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                        <c:if test="${page_num==pageInfo.pageNum}">
                            <li class="active"><a
                                    href="${pageContext.request.contextPath}/selectFlightinfoByAirlinecompanyName.do?pn=${page_num}&airlinecompany_name=${airname}">${page_num}</a>
                            </li>
                        </c:if>
                        <c:if test="${page_num!=pageInfo.pageNum}">
                            <li>
                                <a href="${pageContext.request.contextPath}/selectFlightinfoByAirlinecompanyName.do?pn=${page_num}&airlinecompany_name=${airname}">${page_num}</a>
                            </li>
                        </c:if>
                    </c:forEach>
